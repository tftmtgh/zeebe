...
public class TopologyManagerService extends Actor
  implements TopologyManager, ClusterMembershipEventListener, PartitionChangeListener {
  ...
  public TopologyManagerService(NodeInfo localMember, ClusterCfg clusterCfg, Atomix atomix) {
    this.atomix = atomix;
    ...
    distributionInfo =
      new BrokerInfo()
        .setNodeId(localMember.getNodeId())
    ...
    distributionInfo.setCommandApiAddress(localMember.getCommandApiAddress().toString());
